...
from src.config import NUM_STAGES, DETECTOR_MODEL, CLASSIFIER_MODEL, COMBINED_MODEL, CLASSES, DETECTION_TEST_PATH, YAMNET_EXTRACTED_AUDIO
    ...
    if args.num_stages == 2:
        ...
        if args.classifier_model == "yamnet":
            ...
            events_list = cut_events_from_audio(
                YAMNET_EXTRACTED_AUDIO, events_list
            )
